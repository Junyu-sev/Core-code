...
pro_f_lst = cutoff_df.Pro_code.tolist()
cut_f_lst = cutoff_df.cutoff_result.tolist()
riskdir_f_lst = cutoff_df.HR.tolist()
pval_f_lst = cutoff_df.p_val_new_form.tolist()
hrci_f_lst = cutoff_df.HR_ci.tolist()
