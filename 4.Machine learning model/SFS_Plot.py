...
dpath = '/home/linmiao/ZhangjunYu/Proteomics_analysis/Result/'
output_img_dir = dpath + 'LightGBM/IHD/AccAUC_TotalGain.png'
pro_imp_df = pd.read_csv(dpath + 'LightGBM/IHD/PROImportance.csv')
pro_imp_df.rename(columns = {'TotalGain_cv': 'Pro_imp'}, inplace = True)
pro_auc_df = pd.read_csv(dpath + 'LightGBM/IHD/AccAUC_TotalGain.csv')
